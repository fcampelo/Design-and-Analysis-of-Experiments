...
\flushright{\small ``\textit{There may be some beliefs that cannotbe decided by\\
...
\end{columns}
\vhalf
\let\thefootnote\relax\footnote{\tiny Image: \url{http://www.amazon.com/John-K.-Kruschke/e/B00474BQRQ}}
\end{frame}
