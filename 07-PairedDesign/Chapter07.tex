...
\flushright{\small ``\textit{For me, I am driven by two main philosophies: know\\
...
{\includegraphics[width=\textwidth]{../figs/ndgt01.jpg}};
\end{tikzpicture}
\end{columns}
\vhalf
\let\thefootnote\relax\footnote{\tiny Image: \url{}}
\end{frame}

%% TO INCLUDE: SAMPLE SIZE ESTIMATION WHEN VARIANCE IS UNKNOWN/HARD TO GET (USING COHEN'S D AS EFFECT SIZE)
