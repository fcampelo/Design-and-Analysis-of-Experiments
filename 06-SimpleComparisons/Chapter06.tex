...
\flushright{\small ``\textit{Science is simply common sense at its best,\\
...
{\includegraphics[width=\textwidth]{../figs/huxley.png}};
\end{tikzpicture}
\end{columns}
\vhalf
...
%% TO INCLUDE: SAMPLE SIZE ESTIMATION WHEN VARIANCE IS UNKNOWN/HARD TO GET (USING D*=DELTA*/SIGMA AS ``NORMALIZED'' EFFECT SIZE)
