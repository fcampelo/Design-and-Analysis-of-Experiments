...
## Coleta de dados
A coleta de dados deverá ser simulada mediante o aplicativo disponível em [](). Cada equipe deverá inicialmente realizar o planejamento do experimento e os cálculos de tamanho amostral, e posteriormente gerar a amostra desejada **uma única vez**.
