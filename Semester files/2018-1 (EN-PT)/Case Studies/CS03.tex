...
To generate a Rosenbrock function of a given dimension (p.ex.,
\(dim = 10\)) just do:
...
The variable limits for the Rosenbrock function are defined as
\(-5\leq x_i\leq 10,~i=1,\dotsc,n\).

For any given problem dimension \(dim\), the following parameters are
set as:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dim <-}\StringTok{ }\DecValTok{10} \CommentTok{# for instance}
...
\textbf{Case Study 02}, até a data-limite de \textbf{Terça-feira, 5 de
