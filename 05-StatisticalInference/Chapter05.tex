...
\date{\scriptsize Belo Horizonte\\September 2017}
...
\end{flushright}
  ...
  \node[anchor=south east,xshift=-5pt,yshift=122pt] at (current page.south east) {\tiny Version 2.11.20172};
...
\end{tikzpicture}
\end{columns}
\lfr{Image: Copyright 2008 Ivan Jer\^onimo \url{http://www.ivanjeronimo.com.br} ; \url{https://flic.kr/p/58R1w4}}
\end{ftst}
